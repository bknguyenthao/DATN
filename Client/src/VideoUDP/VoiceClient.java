...
public class VoiceClient {
    ...
    public VoiceClient(int port) throws SocketException, IOException, LineUnavailableException {
        ...
        public void run() {
            try {
                while (true) {
                    ...
                    sendPacket = new DatagramPacket(tempBuffer, tempBuffer.length, InetAddress.getByName(Statics.SERVER_IP), 2000);
