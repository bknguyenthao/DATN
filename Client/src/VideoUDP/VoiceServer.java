...
public class VoiceServer {
    ...
    public VoiceServer(int port) throws SocketException, LineUnavailableException, IOException {
        ...
        public void run() {
            try {
                while (true) {
                    ...
                    sendPacket = new DatagramPacket(tempBuffer, tempBuffer.length,InetAddress.getByName(Statics.CLIENT_IP), 2000);
