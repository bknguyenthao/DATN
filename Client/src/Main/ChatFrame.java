...
public class ChatFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("192.168.43.120");
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // gửi thông điệp có video call đến bên kia
        String target = jList1.getSelectedValue().toString();
        client.send(new Message("videocall", username, "tôi muốn gọi video cho bạn", target));
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // gửi thông điệp Calling đến bên kia
//        String target = jList1.getSelectedValue().toString();
//        client.send(new Message("call", username, "gửi thông điệp có cuộc gọi đến cho bên kia", target));
